function [bestVel,bestPos,insAtt] = readGpsImu_span(gpsPath,gpsFile)
%
...
%
% Reads data file generated by my SPAN CPT
% span logging is configured and controlled by use of a command file


if nargin < 2
    gpsPath = '../SpanCPT/';
    gpsFile = 'span6_test2.txt';
end

% open the file
fid = fopen([gpsPath gpsFile]);
