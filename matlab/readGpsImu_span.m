function [bestVel,bestPos,insAtt] = readGpsImu_span(dataSetID)
...
% 
% change log:
% 05/02/2018    removes path from input argument, now gets path from a
% function if saved gps file is not found
