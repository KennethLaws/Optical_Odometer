/*
Program to read images from Bassler Ace camera and write to disk.  This program for the 
purpose of evalutating maximum frame rate for  optical odometry protype tests

By: Kenneth Laws
Date: 12/4/2017

Code below adapted from Bassler Pylon sample program: SimpleGrab.c
